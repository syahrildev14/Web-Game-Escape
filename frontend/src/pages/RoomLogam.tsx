...
import BgImage from "../assets/background/metal.jpeg";
import LogamPuzzleWrapper from "../components/puzzle/MetalPuzzleWrapper";
...
const RoomLogam: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get("https://api.chemescape.com/api/questions/logam")
      .then((res) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", top: 0, width: "100%", zIndex: 10 }}>
        <Marquee
          text="Ruang metalik berkilau. Atom logam bergerak seragam"
          speed={16}
        />
      ...
      <DialogBox
        ...
        dialog={[
          ...
          "Ikatan logam bergantung pada lautan elektron delokalisasi. Atur kembali kisi logam ini!",
        ]}
      />
